...
const ChoixNumeroInter = ({navigation}:any) => {
    ...
    const showModal = useCallback(async () => {
      ...
      const valideContact = async (num:any) => {
        ...
        const data = [
          {expediteur: num, pays: datas?.pays, reseau: reseau}
        ]
        console.log(data)
        ...
        navigation.navigate("ChoixNumeroDestinataireInter")
      }
      ...
      const handleNext = async () => {
        console.log(currentNumero, reseau)
        if(currentNumero){
          if(reseau != "WAVE")
          {
            switch (reseau)
          ...
          const data = [
            {
                expediteur: {name: user ? user.nomcomplet : '', "phoneNumbers": [{number: currentNumero}]},
                pays: datas.pays,
                reseau: reseau
            }
          ]
        ...
        <SafeAreaView style={styles.container}>
          ...
          <ScrollView contentContainerStyle={{flexGrow: 1}} showsHorizontalScrollIndicator={false}>
            ...
            <KeyboardAvoidingView style={{paddingLeft: 10, paddingRight: 10}}>
                ...
                <Text style={{color: '#01AEB6', fontSize: 25, fontFamily: 'Bold', textAlign: 'center'}}>Détails de l’expéditeur</Text>
                <Text style={{fontWeight: 'bold', fontSize: 20, lineHeight: 28, marginLeft: 12}} >Sélectionnez le réseau à prélever </Text>
                ...
                <Text style={{fontWeight: 'bold', fontSize: 20, lineHeight: 28, marginLeft: 12}} >Selectionnez le numéro à prélever</Text>
...
export default ChoixNumeroInter;
